...
namespace RDSDataObjects
{
    /// <summary>
    /// Provides a format-independant mechanism for transfering data with support for RDS file transfers.
    /// </summary>
    public class RDSDataObject : System.Windows.Forms.IDataObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RDSDataObject"/> class.
        /// </summary>
        /// <param name="underlyingDataObject">The underlying data object to wrap.</param>
        public RDSDataObject(System.Windows.Forms.IDataObject underlyingDataObject)
        {
                ...
                case "FileGroupDescriptorW":
                    ...
                    try
                    {
                        ...
                        if (fileGroupDescriptorStream != null)
                        {
                            ...
                            fileGroupDescriptorBytes[4] = 0;
                            fileGroupDescriptorBytes[5] = 0;
                            ...
                            object fileGroupDescriptorObject;
                            try
                            {
                                fileGroupDescriptorObject = Marshal.PtrToStructure(fileGroupDescriptorWPointer, typeof(NativeMethods.FILEGROUPDESCRIPTORW));
                            }
                            catch (Exception)
                            {
                                return null;
